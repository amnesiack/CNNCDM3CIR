...
parser.add_argument('--test_set', dest='test_set', default='SIDD_validation', help='dataset for testing')
args = parser.parse_args()

def denoiser_test(denoiser):
    test_files_gt = glob('../data/RIDN/{}/groundtruth/*'.format(args.test_set))
    test_files_bl = glob('../data/RIDN/{}/noisy/*'.format(args.test_set))
