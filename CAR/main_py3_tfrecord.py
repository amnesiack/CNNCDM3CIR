...
parser.add_argument('--test_set', dest='test_set', default='LIVE1_rgb', help='dataset for testing')
parser.add_argument('--qp', dest='qp', type=int, default=10, help='qp of the image to test')
args = parser.parse_args()

def denoiser_test(denoiser):
    test_files_gt = sorted(glob('../data/CAR/{}/groundtruth/*'.format(args.test_set)))
    test_files_bl = sorted(glob('../data/CAR/{}/compressed_QP{:0>3d}/*'.format(args.test_set, args.qp)))
